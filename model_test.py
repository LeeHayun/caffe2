...
CAFFE_MODELS = "~/caffe2/build/caffe2/python/models"
...
#IMAGE_LOCATION =  "https://images-na.ssl-images-amazon.com/images/G/01/img15/pet-products/small-tiles/23695_pets_vertical_store_dogs_small_tile_8._CB312176604_.jpg"
#IMAGE_LOCATION = "https://s-media-cache-ak0.pinimg.com/736x/63/0f/0e/630f0ef3f6f3126ca11f19f4a9b85243--dachshund-puppies-weenie-dogs.jpg"
IMAGE_LOCATION = "https://static1.squarespace.com/static/53271e6ce4b0f08e06c5d5cb/t/589dc96a86e6c0e26d97c043/1486735731704/"
...
def rescale(img, input_height, input_width):
    ...
    if(aspect>1):
        ...
        imgScaled = skimage.transform.resize(img, (input_width, res), mode='constant')
    if(aspect<1):
        # portrait orientation - tall image
        res = int(input_width/aspect)
        imgScaled = skimage.transform.resize(img, (res, input_height), mode='constant')
    if(aspect == 1):
        imgScaled = skimage.transform.resize(img, (input_width, input_height), mode='constant')
    pyplot.figure()
